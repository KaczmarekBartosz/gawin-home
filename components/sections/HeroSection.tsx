...
const sofaHotspots = [
  {
    ...
    description:
      "Miękka, pętelkowa struktura - modna, trwała i przyjemna w dotyku",
    position: { x: 55, y: 45 },
  },
  {
    id: 2,
    ...
    description:
      "Charakterystyczne pionowe przeszycia nadają sofie unikalnego charakteru",
    position: { x: 50, y: 58 },
  },
  {
    id: 3,
    ...
    description:
      "Obszerny schowek pod siedziskiem, idealny do przechowywania pościeli i koców",
    position: { x: 45, y: 68 },
  },
  {
    id: 4,
    ...
    description:
      "Łatwe rozkładanie dzięki automatowi - powierzchnia spania 142×198 cm",
    position: { x: 65, y: 35 },
  },
  {
    id: 5,
...
export function HeroSection() {
  ...
  return (
    <section className="w-full bg-brand-cream pt-20 pb-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto bg-brand-cream rounded-3xl overflow-hidden shadow-[0_8px_20px_rgba(150,130,110,0.15)]">
          ...
          <div className="flex flex-col justify-center px-6 sm:px-10 py-12 lg:py-16">
            <div className="flex flex-col max-w-xl space-y-6">
              ...
              <p className="text-base sm:text-lg text-stone-600 leading-relaxed max-w-md">
                Meble, które tworzą przestrzeń pełną spokoju, światła i
                harmonii. Zaprojektowane, by służyć przez lata — i cieszyć
                każdego dnia.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-stone-800 text-stone-100 hover:bg-stone-700 rounded-xl"
                >
                  Przeglądaj kolekcje
                </Button>
                <Button
          ...
          <div className="relative bg-brand-cream w-full h-full flex items-center justify-center overflow-hidden">
            ...
            {sofaHotspots.map((hotspot) => (
              ...
              >
                ...
                <div
                  className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-full border-2 border-white/50 opacity-40 animate-ping"
                ...
                {activeHotspot === hotspot.id && (
                  <div className="absolute z-20 bg-white/80 backdrop-blur-xl border border-stone-200/50 rounded-xl shadow-xl p-4 w-64 -translate-x-1/2 -translate-y-full -top-2 left-1/2">
                    ...
                    <div className="mt-3 pt-3 border-t border-stone-200/30">
                      <Button
                        size="sm"
                        className="w-full bg-stone-800 text-stone-100 hover:bg-stone-700 rounded-lg"
                      >
                        Dowiedz się więcej
                      </Button>
                    </div>
